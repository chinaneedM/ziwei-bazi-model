...
PAGES=tuple(f"{i:04d}" for i in range(3,42))
...
def main():
    ...
    result={"schema":"KYUJANGGAK-1940-PRECIOUS-TITLE-CROPS-R1","book_cd":BOOK_CD,"item_cd":ITEM_CD,"vol_no":VOL_NO,"pages":list(PAGES),"ocr_used":False,"role":"DIRECT_VISUAL_TITLE_REVIEW","records":[],"contact_sheets":[]}
    sheet=[]; sheet_no=1
    for p in PAGES:
