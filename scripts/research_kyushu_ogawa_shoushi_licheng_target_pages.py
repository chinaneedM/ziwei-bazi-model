...
TARGETS = {
    ...
    52: {
        "table_identity": "LUNAR_CHIJI",
        "controls": ["SYM-LUNAR-L35-LOSSGAIN-ZERO"],
        "binding": "SAME_TAIYIN_CHIJI_TABLE_CONTINUATION; PRINTED_LIMITS_26_TO_45_INCLUDE_L35",
        "purpose": "SAME_COPY_POSITIONAL_TYPOGRAPHY_CONTROL_FOR_L132",
    },
    54: {
        "table_identity": "LUNAR_CHIJI",
        "controls": ["SYM-LUNAR-L67-CHIJI-DEGREE-ZERO"],
        "binding": "SAME_TAIYIN_CHIJI_TABLE_CONTINUATION; PRINTED_LIMITS_66_TO_85_INCLUDE_L67",
        "purpose": "SAME_COPY_POSITIONAL_TYPOGRAPHY_CONTROL_FOR_L101",
    },
    55: {
    ...
    58: {
        "table_identity": "LUNAR_CHIJI",
        "controls": ["SYM-LUNAR-L159-LOSSGAIN"],
        "binding": "SAME_TAIYIN_CHIJI_TABLE_CONTINUATION; PRINTED_LIMITS_146_TO_165_INCLUDE_L159",
        "purpose": "SAME_COPY_POSITIONAL_TYPOGRAPHY_CONTROL_FOR_L8",
    },
    68: {
    ...
    70: {
        ...
        "binding": "SAME_CHIJI_XIAN_XINGDU_TABLE; PRINTED_LOWER_BAND_LIMITS_INCLUDE_118_TO_137; L124_ROW_LOCALIZED_BUT_PRINTED_NUMERIC_COLUMNS_REQUIRE_INDEPENDENT_FIELD_IDENTITY_ADJUDICATION_BEFORE_COMPARISON_WITH_JI_XINGDU",
        "purpose": "STRUCTURAL_AND_FIELD_IDENTITY_ADJUDICATION_ONLY_NOT_A_DIRECT_JI_XINGDU_VALUE",
    },
}
REJECTED_PRIOR_BINDING = {
    ...
    "scope": "REJECT_PRIOR_CROSS_TABLE_CHIJI_BINDINGS_ONLY; CANVAS_68_REMAINS_STRUCTURAL_XINGDU_EVIDENCE_AND_CANVAS_70_IS_ONLY_A_VALID_L124_ROW_LOCATOR_UNTIL_PRINTED_NUMERIC_COLUMN_IDENTITY_IS_ADJUDICATED",
...
def main() -> int:
    ...
    result = {
        ...
        "field_identity_invariant": "A_PRINTED_COLUMN_IN_A_SAME_NAMED_OR_RELATED_TABLE_MUST_NOT_BE_ASSUMED_EQUIVALENT_TO_MING_1569_XINGDU_OR_JIEFA_WITHOUT_INTERNAL_SCHEMA_AND_VALUE_CONTROLS",
