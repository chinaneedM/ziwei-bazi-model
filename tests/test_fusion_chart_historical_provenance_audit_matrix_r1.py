...
class HistoricalProvenanceAuditMatrixR1Test(unittest.TestCase):
    ...
    def test_machine_gate_runs(self) -> None:
        ...
        self.assertGreaterEqual(receipt["historical_research_batch_count"], 6)
        self.assertGreaterEqual(receipt["audited_row_count"], 69)
        self.assertEqual(receipt["confirmed_chart_algorithm_defect_count"], 0)
        self.assertGreaterEqual(receipt["confirmed_provenance_metadata_defect_count"], 5)
        self.assertGreaterEqual(receipt["repaired_provenance_metadata_defect_count"], 5)
