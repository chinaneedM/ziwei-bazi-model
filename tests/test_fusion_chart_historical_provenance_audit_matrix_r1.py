...
class HistoricalProvenanceAuditMatrixR1Test(unittest.TestCase):
    ...
    def test_batch_12ao_jielan_complete_public_surface_stays_non_physical_and_fail_closed(self) -> None:
        ...
        self.assertEqual(row["runtime_time_standard_binding_status"], "EARLY_1581_JIELAN_COMPLETE_PUBLIC_TRANSCRIPTION_NONATTESTATION_CONFIRMED_FULLBOOK_INCLEMENT_LUOJING_CLAUSE_REMAINS_SOURCE_SCOPED_AND_CLOCK_INPUT_UNRESOLVED")
