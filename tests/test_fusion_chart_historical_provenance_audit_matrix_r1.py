...
class HistoricalProvenanceAuditMatrixR1Test(unittest.TestCase):
    ...
    def test_machine_gate_runs(self) -> None:
        ...
        self.assertGreaterEqual(receipt["audited_row_count"], 19)
        self.assertEqual(receipt["confirmed_chart_algorithm_defect_count"], 0)
        self.assertGreaterEqual(receipt["confirmed_provenance_metadata_defect_count"], 2)
        self.assertGreaterEqual(receipt["repaired_provenance_metadata_defect_count"], 2)
