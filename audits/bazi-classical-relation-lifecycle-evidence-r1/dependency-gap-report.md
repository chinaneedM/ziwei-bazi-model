...
- Evidence records: `753`
- Conflict groups: `2`
- Profile-candidate records: `3`
...
| `COMMENTARY_OR_EXPLANATION` | 69 |
| `CONTRADICTORY_OR_ALTERNATIVE_STATEMENT` | 3 |
| `DEFINITION_OR_NOMINAL_RELATION` | 78 |
| `ELIGIBILITY_CONDITION` | 58 |
| `EXAMPLE_ONLY` | 19 |
| `EXCEPTION_OR_LIMIT` | 32 |
...
| `CROSS_FAMILY_RELATION_LIFECYCLE` | 338 |
| `HIDDEN_COMBINATION` | 5 |
| `OTHER_UNRELEASED_RELATION` | 7 |
...
- `BRANCH_DIRECTIONAL_TRIAD`: 22 evidence record(s)
...
- `OTHER_UNRELEASED_RELATION`: 7 evidence record(s)
- `PUNISHMENT_INTERACTION_OR_PRECEDENCE`: 194 evidence record(s)
- `ROOT_OR_SUPPORT_GRADE`: 13 evidence record(s)
- `STRENGTH_OR_WANGSHUAI_GRADE`: 20 evidence record(s)
