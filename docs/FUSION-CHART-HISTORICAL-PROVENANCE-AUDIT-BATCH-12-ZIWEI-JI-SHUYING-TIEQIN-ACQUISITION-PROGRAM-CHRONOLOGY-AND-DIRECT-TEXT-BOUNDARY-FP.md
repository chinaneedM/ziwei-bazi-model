# Fusion Chart Historical Provenance Audit R1 — Batch 12FP

## 冀淑英《铁琴铜剑楼藏书的收购入藏》：收购史专题来源、同时代购书旁证与目标册边界

Status: **JI SHUYING 2009 VOLUME + CHAPTER-9 IDENTITY CLOSED / QU→BEIJING-LIBRARY PURCHASE COMPONENT INDEPENDENTLY ATTESTED AT COLLECTION-PROGRAM LEVEL / DONATION COMPONENT ALSO CLOSED / FULL CHAPTER-9 DIRECT TEXT NOT REVIEWED / REPORTED 1950–1953 BATCH COUNTS REMAIN SECONDARY UNTIL DIRECT COLLATION / TARGET 3482-3483 BATCH MEMBERSHIP + PURCHASE/DONATION ROUTE UNRESOLVED / ZERO GENEALOGY OR RUNTIME CHANGE**

## 1. Why this source matters

Batch 12FL already closed the broad fact that Tieqin Tongjian Lou books entered Beijing Library through a mixed donation and priced-acquisition program. Batch 12FO added a 1953 diary-level collection chronology.

The strongest next internal-library source is Ji Shuying's 2009 volume: 冀淑英著、李文洁插图，《冀淑英古籍善本十五讲》，国家图书馆出版社，2009.7，ISBN 9787501340637.

Its ninth lecture is explicitly titled 《铁琴铜剑楼藏书的收购入藏》. The title shows that an old Beijing Library/NLC rare-book specialist treated the Qu transfer as an acquisition-history topic rather than a donation-only story. It does not prove that every Qu item was purchased.

## 2. Bibliographic identity

Independent NDL Search and CiNii catalog controls close the work identity as 冀淑英著、李文洁插图、国家图书馆出版社、2009.7. NLC-hosted 2024 scholarship also cites Ji's 2009 volume in the institutional acquisition-history research chain.

These controls close the work and edition identity, not the wording of chapter 9.

## 3. Chapter 9 identity and access boundary

A public chapter summary reproduces the table of contents and identifies 第九讲《铁琴铜剑楼藏书的收购入藏》, beginning with 常熟瞿氏 and rare-book examples.

The project has not directly reviewed the complete chapter 9 page images or a complete authorized text.
...
12FP records these as secondary recounting only. Some later articles phrase aggregate totals differently, so the repository must not normalize those reports into a single exact machine ledger until chapter 9 and/or an accession ledger is directly reviewed.
...
No reviewed Ji chapter summary, Shen Jin passage, Gu/Deng diary quotation, or accession narrative binds those identifiers to a particular purchase or donation batch.
...
5. Do not choose sale/purchase or donation for the target volume without direct or near-direct item-level evidence.

Research record: `docs/research/ZIWEI-JI-SHUYING-TIEQIN-ACQUISITION-PROGRAM-CHRONOLOGY-AND-DIRECT-TEXT-BOUNDARY-R1.json`.
