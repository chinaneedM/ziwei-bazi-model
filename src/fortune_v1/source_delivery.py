...
def build_source_catalog(manifest_path: str | Path, source_dir: str | Path,
    ...
    for row in manifest["source_files"]:
        ...
        for ordinal, (b0, b1, l0, l1, text) in enumerate(paragraphs(data), 1):
            ...
            entry = {
                ...
                "source_materialization": row.get("source_materialization", {"mode": "DIRECT_FILE"}),
    ...
    return write_object(output, {
        ...
        "source_materialization_policy": manifest.get("materialization_policy", "DIRECT_FILES_ONLY"),
