...
HANDLED_MECHANISM_PROPOSAL_KIND = "REVERSAL_OR_REAPPEARANCE_MECHANISM_PROPOSAL"
HANDLED_SOURCE_CLAIM_EDGE_CLASS = "SOURCE_ASSERTED_REVERSAL_OR_REAPPEARANCE"
...
DISPOSITION_KIND = "SOURCE_ASSERTED_REVERSAL_OR_REAPPEARANCE_EFFECT_DISPOSITION"
...
SOURCE_ASSERTION_SUBTYPE_SPLIT = "NOT_RELEASED_SOURCE_CLASS_REMAINS_COMBINED"
INDEX_SEMANTICS = "IDENTITY_ONLY_NO_MERGE_RANK_ARBITRATION_SELECTION_OR_GLOBAL_STATE"
FRAGMENT_PROJECTION_STATUSES = (
    "REVERSAL_REAPPEARANCE_EFFECT_DISPOSITIONS_PROJECTED",
    "PRESERVED_NO_REVERSAL_REAPPEARANCE_EFFECT_DISPOSITIONS",
...
class ClassicalReversalReappearanceEffectDispositionProfile:
    ...
    source_asserted_disposition: str = SOURCE_ASSERTED_DISPOSITION
    source_assertion_subtype_split: str = SOURCE_ASSERTION_SUBTYPE_SPLIT
    ...
    reversal_reappearance_closure_requirement_id: str = (
        REVERSAL_REAPPEARANCE_CLOSURE_REQUIREMENT_ID
    )
    ...
    global_target_relation_restored_state_semantics: str = "NOT_RELEASED"
    global_target_relation_active_in_force_state_semantics: str = "NOT_RELEASED"
    prior_resolution_execution_semantics: str = "NOT_RELEASED"
    prior_resolution_failure_execution_semantics: str = "NOT_RELEASED"
    ...
    def validate(self) -> "ClassicalReversalReappearanceEffectDispositionProfile":
        if self != ClassicalReversalReappearanceEffectDispositionProfile():
            raise ValueError(
                f"unsupported Unit 10 reversal/reappearance effect disposition profile: {self!r}"
            )
        return self


def bazi_classical_reversal_reappearance_effect_disposition_r1_profile(
) -> ClassicalReversalReappearanceEffectDispositionProfile:
    return ClassicalReversalReappearanceEffectDispositionProfile()
