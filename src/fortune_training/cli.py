...
from .bazi_classical_resolution_effect_disposition.release import (
    validate_release_contract as validate_classical_resolution_effect_disposition_release_contract,
)
from .bazi_classical_resolution_failure_effect_disposition.release import (
    validate_release_contract as validate_classical_resolution_failure_effect_disposition_release_contract,
)
from .bazi_classical_reversal_reappearance_effect_disposition.release import (
    validate_release_contract as validate_classical_reversal_reappearance_effect_disposition_release_contract,
)
from .formal import (
...
def build_parser() -> argparse.ArgumentParser:
    ...
    subparsers.add_parser(
        "classical-relation-interaction-assertion-build",
        help="build the exact-source Classical relation interaction assertion matrix",
    )
    subparsers.add_parser(
    ...
    quarantine_parser = subparsers.add_parser(
        "quarantine-current",
        help="quarantine a contaminated current first-blind case before prediction freeze",
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.command == "verify":
            ...
            result["classical_resolution_effect_disposition"] = validate_classical_resolution_effect_disposition_release_contract(root)
            result["classical_resolution_failure_effect_disposition"] = validate_classical_resolution_failure_effect_disposition_release_contract(root)
            result["classical_reversal_reappearance_effect_disposition"] = validate_classical_reversal_reappearance_effect_disposition_release_contract(root)
            _print_json(result)
        ...
        elif args.command == "classical-relation-interaction-assertion-build":
