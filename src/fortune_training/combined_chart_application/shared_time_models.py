...
class SharedZiweiSelectorProjectionCandidate:
    ...
    historical_hourly_projection_status: str
    historical_hourly_method_candidates: tuple[dict[str, object], ...]
    leap_month_candidate_status: str
