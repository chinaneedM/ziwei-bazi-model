  ...
  <section class="panel form-panel">
    <form id="chart-form">
      ...
      <div class="grid">
        ...
        <label>紫微流月（常规农历月）<input id="ziwei-lunar-month" type="number" min="1" max="12" placeholder="1-12；闰月未裁决"></label>
...
.shensha { margin:8px 0; padding:8px 9px; border:1px solid #e2d7bd; border-radius:8px; background:#fffdf7; }
.shensha-head { font-size:11px; margin-bottom:5px; color:#795548; }
.shensha-items { display:flex; flex-wrap:wrap; gap:5px; }
.shensha-item { padding:4px 6px; border:1px solid #eadfc8; border-radius:5px; background:#fff; font-size:10px; }
