...
from .profile import ResolvedBaziTemporalProfile
...
def validate_dayun_state(
    ...
    if len(month_rows) != 1:
        ...
        for expected_index, frame in enumerate(state.dayun_frames, 1):
            ...
            expected_start = _add_years(state.jiaoyun.first_transition_utc, (expected_index - 1) * 10)
            expected_end = _add_years(state.jiaoyun.first_transition_utc, expected_index * 10)
