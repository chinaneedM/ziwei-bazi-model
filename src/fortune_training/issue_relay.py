...
def process_packet(root: Path, packet: dict[str, Any], key: str | bytes | None) -> dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="fortune-training-relay-") as temporary:
        ...
        result = {
            ...
            "consecutive_passes_before": score["consecutive_passes_before"],
            "consecutive_passes_after": score["consecutive_passes_after"],
            "required_consecutive_passes": score["required_consecutive_passes"],
            "same_case_replay_required": score["same_case_replay_required"],
