...
PROFILE_ID = "BAZI-CLASSICAL-CANDIDATE-PRESERVING-RESOLUTION-FAILURE-EFFECT-DISPOSITION-R1"
PROFILE_VERSION = "1.0.0"
ALGORITHM_ID = PROFILE_ID
ALGORITHM_VERSION = "1.0.0"

HANDLED_SEMANTIC_CANDIDATE_KIND = "SOURCE_GROUNDED_RESOLUTION_FAILURE_CANDIDATE"
HANDLED_MECHANISM_PROPOSAL_KIND = "RESOLUTION_FAILURE_MECHANISM_PROPOSAL"
HANDLED_SOURCE_CLAIM_EDGE_CLASS = "SOURCE_ASSERTED_RESOLUTION_FAILURE"
HANDLED_EFFECT_FACET = "RELATION_EFFECT_DISPOSITION"
FAILURE_CLOSURE_REQUIREMENT_ID = "CLASSICAL_RESOLUTION_FAILURE_SEMANTICS"
...
DISPOSITION_KIND = "SOURCE_ASSERTED_FAILED_RESOLUTION_EFFECT_DISPOSITION"
DISPOSITION_SEMANTIC_SCOPE = "CANDIDATE_LOCAL_SOURCE_ASSERTED_EFFECT_BRANCH_ONLY"
RESOLUTION_MECHANISM_DISPOSITION = "SOURCE_ASSERTED_NOT_HOLDING_AS_RESOLUTION"
INDEX_SEMANTICS = "IDENTITY_ONLY_NO_MERGE_RANK_ARBITRATION_SELECTION_OR_GLOBAL_STATE"
FRAGMENT_PROJECTION_STATUSES = (
    "RESOLUTION_FAILURE_EFFECT_DISPOSITIONS_PROJECTED",
    "PRESERVED_NO_RESOLUTION_FAILURE_EFFECT_DISPOSITIONS",
...
class ClassicalResolutionFailureEffectDispositionProfile:
    ...
    resolution_mechanism_disposition: str = RESOLUTION_MECHANISM_DISPOSITION
    ...
    failure_closure_requirement_id: str = FAILURE_CLOSURE_REQUIREMENT_ID
    ...
    target_relation_restored_state_semantics: str = "NOT_RELEASED"
    reversal_reappearance_semantics: str = "NOT_RELEASED"
    interaction_chain_execution_semantics: str = "NOT_RELEASED"
    ...
    def validate(self) -> "ClassicalResolutionFailureEffectDispositionProfile":
        if self != ClassicalResolutionFailureEffectDispositionProfile():
            raise ValueError(
                f"unsupported Unit 9 resolution-failure effect disposition profile: {self!r}"
            )
        return self


def bazi_classical_resolution_failure_effect_disposition_r1_profile(
) -> ClassicalResolutionFailureEffectDispositionProfile:
    return ClassicalResolutionFailureEffectDispositionProfile()
