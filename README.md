...
截至 Batch 11W，Matrix 仍为 197 个 rule/field families、165 行完成实审；HISTORICALLY_SUPPORTED=87，identified missing candidate families=13，chart algorithm defect=0，algorithm reopen=0，provenance defect=9/9 repaired。11B–11P 的历史历法、明大统历、1673 小川本、G894 与《世宗实录》校勘边界全部保持不变。11Q–11U 已依次收口 G893 的 GitHub-hosted 图像访问边界、战前馆藏连续性、1908/[1912-1920] 目录阴性控制与 1940 贵重书目录正面身份绑定；其中 1940《奎章閣貴重圖書目錄》直接记录 `授時曆立成 = 圖書番號 893 = 1冊`，故现行 `授時曆立成 / 奎貴893 / GK00893_00` 的 catalog-item continuity 维持 `RESOLVED_AT_CATALOG_IDENTIFIER_LEVEL`，而 1930 普通主序号 893 的数字捷径继续被直接证伪。11V 又实测 G893 独立 M/F PDF 路由：`mfPdfList.do` 虽返回正确对象元数据，但结果为 `ERROR - DIR NOT EXIST`、`IS_PDF=null`，直接 `mfPdf.do` 亦无 PDF magic，因此当前在线微缩胶卷 PDF 路径收口为 `CLOSED_NO_DOWNLOADABLE_PDF_OBJECT_OBSERVED`。11W 进一步从《中国科技史料》官方 CBPT/CNKI 期刊门户直接绑定李银姬、景冰 1998《朝鲜奎章阁本的〈授时历立成〉》的 1998-02 期号、paper UUID `5c4276d953bd47ca2679c70209d179cf`、作者单位、摘要、参考文献与 CNKI node `ZGKS802.008`；该来源由“书目见证”升级为“官方记录/摘要直接见证”，但公开页面仍将全文导向 CNKI，未暴露任何六项目标表页或字形，因此六个 G893 控制继续全部 `PENDING_DIRECT_TARGET_PAGE`。1998 摘要只支持“世宗时代刊行”这一论文自身的范围性主张，不裁决现存本 1434/1444 精确年份冲突。确定性排盘核心继续 CLOSED。最新批次见 `docs/FUSION-CHART-HISTORICAL-PROVENANCE-AUDIT-BATCH-11-BAZI-G893-LEE-JING-1998-OFFICIAL-ARCHIVE-W.md`。
