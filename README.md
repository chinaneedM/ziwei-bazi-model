...
截至 Batch 11U，Matrix 仍为 197 个 rule/field families、165 行完成实审；HISTORICALLY_SUPPORTED=87，identified missing candidate families=13，chart algorithm defect=0，algorithm reopen=0，provenance defect=9/9 repaired。11B–11P 的历史历法、明大统历、1673 小川本、G894 与《世宗实录》校勘边界全部保持不变。11Q 收口 G893 GitHub-hosted 图像访问边界，11R 建立战前馆藏连续性与 Rufus 1936 京城帝大王恂《授時曆立成》实物族见证，11S 直接复核 1908《貴重圖書目錄》，11T 又完整无 OCR 复核 provider-dated [1912-1920]《貴重圖書目錄》75 个 renderer 页面；这两批均只形成其各自目录范围内的阴性题名见证。11U 则取得决定性的战前 item-level 正面证据：官方 1940《奎章閣貴重圖書關係書類》（`奎26786 / GK26786_00 / BBG`）内部第 0125 页直接显示《奎章閣貴重圖書目錄》、`朝鮮本（一）`及字段 `書名 / 圖書番號 / 冊數 / 備考`；第 0129 页直接记录 `授時曆立成 = 圖書番號 893 = 1冊`，并将相邻姜保《授時曆捷法立成》单列为 `892 = 1冊`。现行官方记录为 `授時曆立成 / 奎貴893 / GK00893_00`，结合官方馆藏移交连续性，项目现将 `EXACT_ITEM_CONTINUITY_TO_CURRENT_GK00893_00` 收口为 `RESOLVED_AT_CATALOG_IDENTIFIER_LEVEL`。同时，1930 普通《奎章閣圖書番號順目錄》的主序号 893 已被直接页读证伪为当前贵重本 893 的数字捷径，禁止混用。上述身份收口仍不赋予任何 G893 target folio、glyph、exact print year 或数值权威；六个 G893 控制全部继续 `PENDING_DIRECT_TARGET_PAGE`，确定性排盘核心保持 CLOSED。最新批次见 `docs/FUSION-CHART-HISTORICAL-PROVENANCE-AUDIT-BATCH-11-BAZI-G893-1940-PRECIOUS-CATALOG-U.md`。
