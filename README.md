...
截至 Batch 07B，Matrix 已扩展到 138 个 rule/field families，其中 88 行完成实审；已确认并在 provenance 层 forward-only 修复/隔离 6 个 metadata defects，仍未发现 chart algorithm defect，也没有任何 algorithm reopen。Batch 07B 继续拆解 Operational minor-star family，并把天官/天福、天空、旬中空亡两宫几何、截路空亡、孤辰寡宿、劫煞、华盖、桃花杀→咸池几何、 大耗、破碎与天才共 11 个规则族绑定到 1581《新刻纂集紫微斗数捷览》的独立章节见证；其中旬空的主/副显示排序没有被冒充为 1581 原法，天寿也继续保持 07A 的争议候选状态。Batch 07A 的天厨与天寿冲突仍未被折叠。1581《新刻纂集紫微斗数捷览》候选族继续由上海图书馆古籍联合目录“明万历九年金陵书坊王洛川刻本（子4051）”提供独立书目身份见证。Batch 07A 见 `docs/FUSION-CHART-HISTORICAL-PROVENANCE-AUDIT-BATCH-07-ZIWEI-MINOR-STARS-A.md`；Batch 07B 见 `docs/FUSION-CHART-HISTORICAL-PROVENANCE-AUDIT-BATCH-07-ZIWEI-MINOR-STARS-B.md`。
