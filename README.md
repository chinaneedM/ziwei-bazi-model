...
截至 Batch 11R，Matrix 仍为 197 个 rule/field families、165 行完成实审；HISTORICALLY_SUPPORTED=87，identified missing candidate families=13，chart algorithm defect=0，algorithm reopen=0，provenance defect=9/9 repaired。11B/11C 把大运真实交运历日与现代日历实现拆开并建立 fail-closed historical-calendar adapter contract；11D-11G 闭合明大统历一手方法源、1578 官方实录月朔 oracle、D1/迟疾行度生产算法与子正/100刻内部时间坐标；11H/11I 完成 1578 的 13/13 日级源算法重放与同年 NCL 06313 钦天监原历 12/12 月页直接影像校勘；11J 闭合 1569 主表的阶段化精度图并否定“全局统一舍入法”。11K/11L 完成 1673 小川本 NDL/九州独立馆藏校勘并建立 L124 捷法/倒数层证据边界；11M 保持 G893 现存本精确印年在世宗 1418–1450 区间内未决，并绑定公开实物开篇图而保持六个 target 全部 fail-closed。11N–11P 建立并直接校勘 G894 /《世宗实录》独立朝鲜见证；11Q 收口 G893 GitHub-hosted 图像访问边界并登记非 GitHub / legacy mirror 路线。11R 进一步闭合战前馆藏层：SNU 官方馆史证明 1928–1930 规章阁藏书转入京城帝国大学、1946 又在册数和保存地点不变的情况下转归首尔大学；Rufus 1936 则独立记录京城帝大图书馆确有一部与姜保本分开的、未注明年代且署王恂的《授時曆立成》。但该记录没有 `奎貴893`、`GK00893_00`、102张、38×24.8cm、`M/F73-102-37-A` 或实物印记，因此只能闭合“战前同名王恂本实物族”，不能直接宣布就是现存 G893。1930 京城帝大附属图书馆《奎章閣圖書番號順目錄》（`奎26775-v.1-7`）现被确定为下一项级绑定入口，其内部《授時曆立成》条目尚未直接读取。G893 六个目标仍全部 `PENDING_DIRECT_TARGET_PAGE`，未从任何旁证预填数值；历史历法 runtime 继续 fail-closed。最新批次见 `docs/FUSION-CHART-HISTORICAL-PROVENANCE-AUDIT-BATCH-11-BAZI-G893-PREWAR-COLLECTION-CONTINUITY-R.md`。
