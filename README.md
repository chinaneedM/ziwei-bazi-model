...
截至 Batch 11S，Matrix 仍为 197 个 rule/field families、165 行完成实审；HISTORICALLY_SUPPORTED=87，identified missing candidate families=13，chart algorithm defect=0，algorithm reopen=0，provenance defect=9/9 repaired。11B–11P 的历史历法、明大统历、1673 小川本、G894 与《世宗实录》校勘边界全部保持不变。11Q 收口 G893 GitHub-hosted 图像访问边界，11R 建立战前馆藏连续性与 Rufus 1936 京城帝大王恂《授時曆立成》实物族见证，但 exact item identity 到现存 `奎貴893 / GK00893_00` 仍为 UNRESOLVED。11S 又直接绑定规章阁 1908《貴重圖書目錄》（`古016.09-G995 / GR35006_00 / BBG`）并通过官方 `mfPdf.do` 路由取得原 PDF；该 PDF 1,746,005 bytes、SHA-256 `b4b7b14229a82f3f5da12dc069cf8943b1d4c1ff7ca0aa87e85eb3e5d2b06328`，全程 OCR=false。人工目视完整子部范围后，未见《授時曆立成》或简称《授時曆》。这一结果只是一条 1908 贵重目录的直接负面题名见证：禁止解释为 G893 实物当年不存在、禁止把今天贵重本身份反投射到 1908、禁止据此宣布与 Rufus 1936 实物断裂，也不影响印年或六个 target。当前历史窗口为“1908 贵重目录题名未见 → 1936 京城帝大明确见到王恂《授時曆立成》”，下一控制点是 1912 目录及 1930 番号顺目录的具体条目。G893 六个目标仍全部 `PENDING_DIRECT_TARGET_PAGE`；历史历法 runtime 继续 fail-closed。最新批次见 `docs/FUSION-CHART-HISTORICAL-PROVENANCE-AUDIT-BATCH-11-BAZI-G893-1908-PRECIOUS-CATALOG-S.md`。
