...
截至 Batch 11I，Matrix 仍为 197 个 rule/field families、165 行完成实审；HISTORICALLY_SUPPORTED=87，identified missing candidate families=13，chart algorithm defect=0，algorithm reopen=0，provenance defect=9/9 repaired。11B/11C 把大运真实交运历日与现代日历实现拆开并建立 fail-closed historical-calendar adapter contract；11D-11G 闭合明大统历一手方法源、1578 官方实录月朔 oracle、D1/迟疾行度生产算法与子正/100刻内部时间坐标。1569 周相本的直接逐行校勘现已闭合为太阳 185/185、太阴迟疾 169/169、太阴行度 169/169，原刻层零歧义；跨版本异文成因与通用截位/进位规则仍继续审计。11H 用该方法及重构数表从源头完整重放 1578，万历六年十二个月加次年正月锚点共 13/13 日级吻合。11I 又取得同年 NCL 06313 钦天监原历此前唯一无法渲染的六月页直接影像：零基 PDF 第 13 页清楚显示“六月小”，使十二个月页达到 12/12 直接影像校勘、0 个月名或大小月冲突。该闭合只覆盖同年物理月页的月名/大小月层；细小月首干支字形、朔的精确时刻与经度基准、多年闰月、十年递推和历史历法 runtime 仍保持未闭合。三个 Dayun calendarized candidate 继续 `MISSING_FROM_PRODUCT`，不得因本批次启用 runtime。最新批次见 `docs/FUSION-CHART-HISTORICAL-PROVENANCE-AUDIT-BATCH-11-BAZI-MING-DATONG-1578-PHYSICAL-ALMANAC-CLOSURE-I.md`。
