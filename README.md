...
截至 Batch 10B，Matrix 已扩展到 186 个 rule/field families，其中 153 行完成实审；chart algorithm defect=0，algorithm reopen=0，identified missing candidate families=12。10B 审计了 raw core 有意排除的关系族：明代《三命通会》“属象/一方之气”的四组三支方向组合与后世“方/三会”做异名同机械桥，但绝不与三合混并；宋《五行精纪》引《李虚中书》只给四破，并明确寅申巳亥无破，因此后世六破不能冒充古法唯一表；半三合/拱合只保留 modern compatibility 身份，完整三合仍坚持三支缺一不成局；《三命通会》座下自化与后世干支暗合闭合为同柱天干↔本支藏干五合候选。新增 source-closed 缺口为三会方、早期四破、同柱暗合。Batch 10B 见 `docs/FUSION-CHART-HISTORICAL-PROVENANCE-AUDIT-BATCH-10-BAZI-EXCLUDED-RELATION-FAMILIES-B.md`。
